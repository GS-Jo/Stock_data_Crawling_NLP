# 주식데이터 크롤링 및 텍스트마이닝을 통한 주가예측 프로젝트

## Target
### (1) Scrapy를 활용한 주식뉴스 및 주가데이터 크롤링

### (2) 증권뉴스 데이터와 주가데이터를 활용한 주가예측 
    - 증권뉴스 텍스트마이닝을 통해 특정 기사 제목을 입력했을 때 해당기사가 주가에 긍정적인가, 부정적인가를 예측하여 보자.
    - 예시: '광주 악몽 HDC현대산업개발, 7개월만에 또 사고…휘청' => 주가에 부정적
    
#### cf) Word2vec을 활용한 유사도분석
...
- 크롤링한 주가데이터를 활용하여 해당 뉴스가 개제된날의 주식 등락률을 0,1로 라벨링하여, 주식 뉴스 텍스트분
...
#### <결과>
- gensim word2vec 활용하여 특정키워드와 관련있는 단어들을 추출
